...
// const filterCarAvailableTrue = (char) => {

//     let newCar = AllCar.filter(cars => cars.available.toLowerCase().includes("Dengan Sopir") && cars.available == false)
//     const body = document.getElementById('body')
//     body.innerHTML = ''
...
// const filterCarAvailableFalse = (char) => {

//     let newCar = AllCar.filter(cars => cars.available.toLowerCase().includes("Tanpa Sopir (Lepas Kunci)") && cars.available == false)
//     const body = document.getElementById('body')
//     body.innerHTML = ''
//             newCar.forEach((element, id) => {
//                 const Car = document.createElement('div')
